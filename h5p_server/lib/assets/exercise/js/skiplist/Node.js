...
Node.prototype.elemWidth = function(){ return $(this.getElem()).width(); }
Node.prototype.elemHeight = function(){ return $(this.getElem()).height(); }
...
Node.prototype.isDataHidden = function(){
	return $(DOM.dataFrom (this.getElem ())).hasClass ("hidden");
}
